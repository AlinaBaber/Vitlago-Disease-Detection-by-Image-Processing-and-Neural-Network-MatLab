function [mean_cluster_value]=Color_Detection_test(image_file)
fruit = imread(image_file);
[BW,he] = createMask(fruit);
figure,imshow(fruit), title('Orignal image');
...
figure,imshow(blue_nuclei), title('Color nuclei');
transpose(mean_cluster_value); 
%figure,staris(blue_nuclei), title('Color nuclei');
